...
Working examples are available in the [examples/fan-control](https://github.com/MichaelTien8901/openbmc-guide-tutorial/tree/main/docs/examples/fan-control) directory:
