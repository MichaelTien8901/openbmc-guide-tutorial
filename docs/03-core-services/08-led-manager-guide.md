...
Working examples are available in the [examples/led-manager](https://github.com/MichaelTien8901/openbmc-guide-tutorial/tree/main/docs/examples/led-manager) directory:
