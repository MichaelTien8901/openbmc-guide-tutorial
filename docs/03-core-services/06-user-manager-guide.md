...
Working examples are available in the [examples/user-manager](https://github.com/MichaelTien8901/openbmc-guide-tutorial/tree/main/docs/examples/user-manager) directory:
