...
Working examples are available in the [examples/entity-manager](https://github.com/MichaelTien8901/openbmc-guide-tutorial/tree/main/docs/examples/entity-manager) directory:
