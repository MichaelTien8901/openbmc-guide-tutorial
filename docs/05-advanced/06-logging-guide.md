...
Working examples are available in the [examples/logging](https://github.com/MichaelTien8901/openbmc-guide-tutorial/tree/main/docs/examples/logging) directory:
