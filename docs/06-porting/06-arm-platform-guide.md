...
Working examples are available in the [examples/porting/meta-arm-example](https://github.com/MichaelTien8901/openbmc-guide-tutorial/tree/main/docs/examples/porting/meta-arm-example) directory:
