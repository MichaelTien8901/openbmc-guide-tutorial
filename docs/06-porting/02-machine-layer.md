...
Working examples are available in the [examples/porting](https://github.com/MichaelTien8901/openbmc-guide-tutorial/tree/master/docs/examples/porting) directory:
